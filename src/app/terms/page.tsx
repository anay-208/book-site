          ...
          <div className="mx-auto max-w-3xl space-y-8">
            ...
            <div className="space-y-6 text-gray-500">
              <div className="space-y-2">
                ...
                <p>
                  This website is a hobby project created for educational and demonstration purposes only. It is not a
                  real commercial service, and no actual products will be delivered.
                </p>
              </div>

              <div className="space-y-2">
                <h2 className="text-xl font-bold tracking-tight">About the Project</h2>
                <p>
                  This website was created as part of a Business Management project to demonstrate a fictional product -
                  customized stone paper notebooks. All information, including pricing, product specifications, and
                  services offered, is fictional.
                </p>
              </div>
              ...
              <div className="space-y-2">
                ...
                <p>For any questions about this project, please contact Anay Paraswani.</p>
              </div>
            </div>
